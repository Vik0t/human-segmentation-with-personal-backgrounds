...
export default function Home() {
  ...
  return (
    <div className="h-full w-full flex flex-col items-center justify-center gap-4 bg-gray-100 p-8">
      <h1 className="m-0 text-3xl font-bold text-center text-gray-800">
        WebRTC Webcam
      </h1>
      <div className="h-full bg-gray-200 rounded-lg overflow-hidden relative">
        <video
          ...
          autoPlay
          playsInline
          className={`absolute top-5 left-5 w-30% h-30% object-cover border-2 border-gray-300 rounded-lg ${
